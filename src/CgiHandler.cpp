...
/*   Updated: 2025/05/05 15:09:53 by ewu              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
std::vector<char*> CgiHandler::createEnv(const HttpRequest& httpReq, const std::string& req_url, const std::string& rootPath)
{
...
std::vector<char*> CgiHandler::_convertToEnvp(std::vector<std::string>& envStr)
{
